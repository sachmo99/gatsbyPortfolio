...
const Popup: React.FC<ModalProps> = ({ heading,isOpen, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      ...
      <div className="bg-white rounded-lg shadow-lg max-w-lg max-h-screen overflow-y-auto p-6 h-auto relative transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110">
      <div>
